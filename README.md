...
```bash
code-insiders --install-extension /path/to/josh-room-0.1.17.vsix
```
...
josh-room auth start [--purpose encryption|r2] | wait [--purpose encryption|r2] | cancel | status [options] [--json]
